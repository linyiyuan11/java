...
概念： redis 是一款高性能的 NoSQL 系列的非关系型数据库（键值对数据库 ）

![image-20221005204752915](C:\Users\lin\AppData\Roaming\Typora\typora-user-images\image-20221005204752915.png)
...
![image-20221005212007031](C:\Users\lin\AppData\Roaming\Typora\typora-user-images\image-20221005212007031.png)
...
因为String类型只能存储字符串，所以当我们要存储一个比较复杂的value时，只能先把这个value先序列化为json格式。但这样有一个弊端，就是修改时只能全覆盖这个字符串，不能对字符串中的一些键值对进行修改。

![image-20221006201641455](C:\Users\lin\AppData\Roaming\Typora\typora-user-images\image-20221006201641455.png)
...
![image-20221006203408340](C:\Users\lin\AppData\Roaming\Typora\typora-user-images\image-20221006203408340.png)
...
由链表实现。双向链表实现的，与Java中的LinkedList，可以看作是一个双向链表结构。既可以支持正向检索，也可以支持反向检索。
